...
object Const {
    ...
    private const val IB_VERIFY_POWER = 30
    var ibVerifyPower: Int
        get() = SPUtils.getInt("IB_VERIFY_POWER", IB_VERIFY_POWER)
        set(value) = SPUtils.putInt("IB_VERIFY_POWER", value)
